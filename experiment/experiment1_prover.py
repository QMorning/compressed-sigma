...
for line in content:  
    ...
    if line.startswith('Sumcheck on F+G Prover time') and current_experiment == "experiment 1-1":             
            time_data = extract_number(line)
            prover_time_deg_1.append(time_data)         
...
for line in content:  
    ...
    elif line.startswith('Sumcheck on F+G Prover time') and current_experiment == "experiment 1-2":             
            time_data = extract_number(line)
            prover_time_deg_2.append(time_data)         
...
for line in content:  
    ...
    elif line.startswith('Sumcheck on F+G Prover time') and current_experiment == "experiment 1-3":             
            time_data = extract_number(line)
            prover_time_deg_4.append(time_data)         
